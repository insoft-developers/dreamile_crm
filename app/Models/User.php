...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = ['name', 'email', 'password', 'position', 'level', 'branch_id', 'photo_profile', 'last_seen', 'phone_number'];
    ...
    {
        return $this->hasMany(Customer::class, 'consultant_id', 'id');
    }
