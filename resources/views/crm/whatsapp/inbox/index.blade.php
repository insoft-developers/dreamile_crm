                    ...
                    <div class="p-5">
                        <div class="mb-2">
                            <div class="d-flex align-items-center justify-content-between position-relative">
                                ...
                                <div class="d-xl-none position-absolute" style="right: -38px;" data-bs-toggle="tooltip"
                                    data-bs-trigger="hover" data-bs-placement="bottom" aria-label="Close Button"
                                    data-bs-original-title="Close Button" aria-describedby="tooltip430017">
                                    <a href="javascript:void(0)" class="bg-light text-success p-2 rounded-pill"
                                        id="close-chat-sidebar">
                                        <i class="ri-arrow-left-double-fill fs-5"></i>
                                    </a>
                                </div>
                                <div class="d-none d-xl-block" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                    data-bs-placement="bottom" aria-label="Add Contact"
                                    data-bs-original-title="Add Contact" aria-describedby="tooltip430017">
                                ...
                                <div class="chat-room-list mx-n5" data-simplebar>
                                    <ul id="chatList" class="list-unstyled mb-0">
                                        ...
                                        <li id="chat2" class="d-flex align-items-center gap-3 px-4 py-3 mb-2">
                                            <div class="avatar-wrapper active flex-shrink-0 position-relative">
                                                <img src="{{ asset('template/crm') }}/assets/images/avatar/avatar-12.jpg"
                                                    class="avatar-lg rounded-circle" height="36" alt="avatar">
                                            </div>
                                            <div class="flex-grow-1 overflow-hidden">
                                                <h6 class="my-0">
                                        ...
                                        <li id="chat6" class="d-flex align-items-center gap-3 px-4 py-3 mb-2">
                                            <div class="avatar-wrapper flex-shrink-0 position-relative">
                                                <img src="{{ asset('template/crm') }}/assets/images/avatar/avatar-6.jpg"
                                                    class="avatar-lg rounded-circle" height="36" alt="avatar">
                                            </div>
                                            <div class="flex-grow-1 overflow-hidden">
                                                <h6 class="my-0">
                                        ...
                                        <li id="chat7" class="d-flex align-items-center gap-3 px-4 py-3 mb-2">
                                            <div class="avatar-wrapper active flex-shrink-0 position-relative">
                                                <img src="{{ asset('template/crm') }}/assets/images/avatar/avatar-7.jpg"
                                                    class="avatar-lg rounded-circle" height="36" alt="avatar">
                                            </div>
                                            <div class="flex-grow-1 overflow-hidden">
                                                <h6 class="my-0">
                                        ...
                                        <li id="chat9" class="d-flex align-items-center gap-3 px-4 py-3 mb-2">
                                            <div class="avatar-wrapper flex-shrink-0 position-relative">
                                                <img src="{{ asset('template/crm') }}/assets/images/avatar/avatar-9.jpg"
                                                    class="avatar-lg rounded-circle" height="36" alt="avatar">
                                            </div>
                                            <div class="flex-grow-1 overflow-hidden">
                                                <h6 class="my-0">
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-4 col-8">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 d-block d-xl-none me-4">
                                        <a href="#!" class="btn btn-light icon-btn fs-5"
                                            id="open-chat-sidebar"><i class="ri-menu-2-fill"></i></a>
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                                        <div id="selectedUserProfile" class="d-flex align-items-center gap-2">
                                            <div id="selectedUserAvatarWrapper"
                                                ...
                                                <img id="selectedUserAvatar"
                                                    src="{{ asset('template/crm') }}/assets/images/avatar/avatar-12.jpg"
                            ...
                            <div class="col-sm-8 col-4">
                                <div class="d-flex gap-2 justify-content-end">
                                    ...
                                    <div class="dropdown">
                                        <a href="javascript:void(0)" class="btn btn-light icon-btn"
                                            data-bs-toggle="dropdown" aria-expanded="true" aria-expanded="false"> <i
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a class="dropdown-item" href="javascript:void(0)" id="clearChat">Clear
                                                Chat</a>
                                ...
                                <div class="col-auto">
                                    <div class="chat-input-links ms-2">
                                        <div class="d-flex gap-4 align-items-center">
                                            <a href="#!" class="link text-body fs-4" data-bs-toggle="tooltip"
                                                data-bs-html="true" title="Attach a Link">
                                                <i class="ri-link-m"></i>
                                            </a>
                                            <div class="file-upload">
                                                <a href="#!" class="link text-body fs-4"
                                            ...
                                            <a href="#!" class="link text-body fs-4" data-bs-toggle="tooltip"
                                                data-bs-html="true" title="Send an Emoji">
