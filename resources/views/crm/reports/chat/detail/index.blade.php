                ...
                <div class="flex-shrink-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-end mb-0">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a href="{{ url('/chat_report') }}">Chat History Report</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Chat History Detail Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h5 class="card-title mb-0"> Chat History Detail Report </h5>
...
@push('scripts')
    @include('crm.reports.chat.detail.js')
@endpush
